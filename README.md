...
| [`buildImageName`](https://github.com/pacificclimate/jenkins-library/blob/master/vars/buildImageName.groovy) | Constructs a Docker image name given some parameters. |
...
| [`removeDockerImage`](https://github.com/pacificclimate/jenkins-library/blob/master/vars/removeDockerImage.groovy) | Removes the built Docker image from a server. |
